...
from preProcessing.DensePose.projects.DensePose.densepose import (
...
from preProcessing.DensePose.projects.DensePose.densepose.data import DatasetMapper, build_detection_test_loader, build_detection_train_loader
