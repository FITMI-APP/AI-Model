...
from preProcessing.DensePose.projects.DensePose.densepose.data.datasets.builtin import COCO_DATASETS, DENSEPOSE_ANNOTATIONS_DIR, LVIS_DATASETS
from preProcessing.DensePose.projects.DensePose.densepose.data.datasets.coco import load_coco_json
from preProcessing.DensePose.projects.DensePose.densepose.data.datasets.lvis import load_lvis_json
from preProcessing.DensePose.projects.DensePose.densepose.data.utils import maybe_prepend_base_path
