...
from preProcessing.DensePose.projects.DensePose.densepose.data.meshes.catalog import MeshCatalog
from preProcessing.DensePose.projects.DensePose.densepose.modeling.cse.utils import normalize_embeddings, squared_euclidean_distance_matrix
