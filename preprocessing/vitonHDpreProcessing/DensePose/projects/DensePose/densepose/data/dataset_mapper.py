...
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.structures import DensePoseDataRelative, DensePoseList, DensePoseTransformData
