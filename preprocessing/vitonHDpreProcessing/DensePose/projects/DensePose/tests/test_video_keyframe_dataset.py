...
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.transform import ImageResizeTransform
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.video import RandomKFramesSelector, VideoKeyframeDataset
