...
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.datasets.builtin import COCO_DATASETS, DENSEPOSE_ANNOTATIONS_DIR, LVIS_DATASETS
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.datasets.coco import load_coco_json
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.datasets.lvis import load_lvis_json
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.data.utils import maybe_prepend_base_path
