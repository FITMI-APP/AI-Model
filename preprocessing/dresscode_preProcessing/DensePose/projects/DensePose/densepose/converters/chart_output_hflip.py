...
from preprocessing.dresscode_preProcessing.DensePose.projects.DensePose.densepose.structures import DensePoseChartPredictorOutput, DensePoseTransformData
